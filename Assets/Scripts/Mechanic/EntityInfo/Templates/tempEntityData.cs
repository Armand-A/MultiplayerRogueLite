...
public class tempEntityData : MonoBehaviour
{
    public EntityStatManager StatManager;
    ...
    {
        return false;// EntityAction.UpdateValue(actionCost);
    }

    public bool UpdateHealth(float deltaHealth)
    {
        EnterCombatMode();
        return false; // EntityHealth.UpdateValue(deltaHealth);
    }
